...
#read in my data
lchdu0 = fits.open('tess2021232031932-s0042-0000000405484188-0213-s_lc.fits')
...
#read in my data
lchdu1 = fits.open('tess2021258175143-s0043-0000000405484188-0214-s_lc.fits')
...
#read in my data
lchdu2 = fits.open('tess2021284114741-s0044-0000000405484188-0215-s_lc.fits')
...
with open("newHD23607_GLSready.csv", 'w') as file:
